...
class NPM(Command):
    ...
    targets = [
        os.path.join(here, 'cornerstone_widget', 'static', 'extension.js'),
        os.path.join(here, 'cornerstone_widget', 'static', 'index.js')
    ]
...
setup_args = {
    ...
    'data_files': [
        ('share/jupyter/nbextensions/cornerstone_widget', [
            'cornerstone_widget/static/extension.js',
